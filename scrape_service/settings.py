"""
Django settings for scrape_service project.
...
SECRET_KEY = "django-insecure-81li)^a3a0g&d3mt3&)ohf*s5^1xbi0reuel-op2pz)i!*dzzw"
...
ROOT_URLCONF = "scrape_service.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [BASE_DIR / "scrape_service/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "scrape_service.wsgi.application"
...
# ─── Telegram ─────────────────────────────────────────────────────────────────
# Get these from @BotFather and your Telegram user/group ID
